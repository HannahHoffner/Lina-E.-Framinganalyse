...
#---------------------------------   Preprocess data
# read data:
textdata <- read.csv("output1.csv", sep = ",", encoding = "UTF-8")
Lina_corpus <- corpus(textdata$"Body", docnames = textdata$DocumentNumber)
...
#remove rechts and connected words from stopwordlist
...
top_terms <- c("Lina E.","https://www.saechsische.de","pdf-datei","original_gesamtseiten-pdf_graphic","page_of","gesamtseiten-pdf","page","graphic","dokuments","seite","of")
